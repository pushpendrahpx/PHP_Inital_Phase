...
<div class="content" id="content">
	<div class="navbar">
		...
		<div class="navtoggler-content">
			<a href='register.html' class="nav-item waves-effect waves-light text-white bg-primary" style="border-radius: 3px;text-decoration: none;">Student Registration</a>
	...
	<div class="main-content" style="width: 100%;">
				...
				<section class="features-section">
			  		<div class="wrapper">
			  			<div class=" waves-effect h1 text-center" style="width: 100%;">Register Sucessfull</div>
			  			<div class="services-content">
			  				<div class="container">
			  					<a class="lead btn btn-success" href="https://www.facebook.com/chintanpratishthan/" style="color: black">
			  						Our FaceBook Page
			  					</a>
			  					<br />
			  				</div>		
