...
<script>
		...
		localStorage.setItem("is","visited");
</script>
...
<div class="content" id="content">
	<div class="navbar">
		<a href="#homepage" style="text-decoration: none;"><div class="navbar-brand waves-effect waves-light" style="padding:5px;border-radius: 2px;font-size: 25px;">Chintan Book Bank</div></a>
		...
		<div class="navtoggler-content">
			<!-- <a href='register.html' class="nav-item waves-effect waves-light text-white bg-success" style="box-shadow: 0 0 10px green;border-radius: 3px;text-decoration: none;">Register Now for Hackathon</a>
			...
			<a class="waves-effect waves-light nav-item" style="color: #dedede">A Student Chapter of SVNIT</a>		
	</div>
	</div>
	...
	<div class="main-content" style="width: 100%;">
				...
				<section class="features-section">
			  		<div class="wrapper">
			  			<div class=" waves-effect h1 text-center" style="width: 100%;"></div>
			  			<div class="services-content">
			  				<div class="container">
			  					<a class="lead">You'll be added soon in <br />"Center Fr Self Development" group.</a>
			  				</div>		
			  			</div>
			  			</div>
			  		</section>
			  		...
			  		<footer>
			  			<div class="row" style="margin:5px;color:white;">
			  				...
			  				<div class="col-sm-12 col-lg-12">
			  					...
			  					<div class="card-body text-center">
			  						<a href="https://www.facebook.com/chintanpratishthan/" class="waves-effect">Facebook</a><br /><!-- 
			  						<a href="Link 1" class="waves-effect">Twitter</a><br />
			  						<a href="Link 1" class="waves-effect">Instagram</a><br />
			  					 --></div>
			  				</div>
			  			</div>
